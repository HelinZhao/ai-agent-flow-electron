...
const PROVIDER_DEFAULT_CAPABILITIES: Record<string, string[]> = {
...
export const ALL_CAPABILITIES = [
  { key: 'text', label: '文本生成', description: '基础文本对话' },
  { key: 'vision', label: '图片识别', description: '支持图片输入' },
  { key: 'tool_use', label: '工具调用', description: 'Function Calling / Tool Use' },
  { key: 'streaming', label: '流式输出', description: 'SSE 流式响应' },
]
