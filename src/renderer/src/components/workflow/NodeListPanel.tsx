...
const NodeListPanel = (): React.JSX.Element => {
  ...
  return (
    <div className="w-56 flex-shrink-0 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border-l border-slate-200 dark:border-slate-700 h-full flex flex-col overflow-hidden">
