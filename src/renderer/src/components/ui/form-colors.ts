...
export const formColors = {
  // 边框颜色
  border: {
    default: 'border-gray-300/70 dark:border-gray-600/50',
    hover: 'hover:border-gray-400/70 dark:hover:border-gray-500/50',
...
export const formClasses = {
  input: {
    base: 'border transition-[border-color,box-shadow,background-color,opacity] duration-200 backdrop-blur-sm',
