...
const Layout: React.FC<LayoutProps> = ({ children, currentPage, onNavigate }: LayoutProps) => {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-slate-800">
      {/* 左侧边栏导航 */}
      <nav className="hidden md:block bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-sm border-r border-gray-200/50 dark:border-gray-700/50 flex-shrink-0 z-40 w-16">
        <div className="flex flex-col h-[calc(100%-4rem)] mt-16">
          {/* 导航项 */}
      ...
      {/* 顶部工具栏 */}
      <div className="hidden md:flex fixed top-0 left-0 right-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-sm border-b border-gray-200/50 dark:border-gray-700/50 flex-shrink-0 z-40 h-16">
      ...
      {/* 主内容区域 */}
      <main className="flex-1 overflow-auto relative md:ml-0 md:mt-16 mt-16">
